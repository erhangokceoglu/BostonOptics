...
namespace ApplicationCore.Services
{
    public class BasketService : IBasketService
    {
        ...
        public async Task<Basket> AddItemToBasketAsync(string buyerId, int productId, int quatity)
        {
        ...
        public async Task EmptyBasketAsync(string buyerId)
        {
            ...
            foreach (var item in basket.Items.ToList()) { await _basketItemRepo.DeleteAsync(item); }
        }
